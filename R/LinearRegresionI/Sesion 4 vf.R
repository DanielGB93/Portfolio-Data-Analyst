...
#-----------------------------------------
# Recodificaci?n y selecci?n de variables
#-----------------------------------------
base %>% 
  count(dominio)
...
stargazer(reg1, reg2, reg3, type="text", title="Modelos de regresi?n lineal",
          column.labels =  c("Modelo 1", "Modelo 2", "Modelo 3"))


#Analisis de criterio de informaci?n
#-----------------------------------
AIC(reg1, reg2, reg3)
BIC(reg1, reg2, reg3)

#========================================
#4. Post Estimaci?n (test de diagnostico)
#========================================
...
#===================================
#5. Correci?n de heterocedasticidad
#===================================
...
stargazer(reg3, reg3_mcp, type="text", title="Correcci?n de heterocedasticidad")
